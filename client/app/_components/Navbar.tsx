...
const watchedIcon = (watchedMenu?<span className='pi pi-angle-up ml-1'></span>:<span className='pi pi-angle-down ml-1'></span>)
const recomIcon = (recomMenu?<span className='pi pi-angle-up ml-1'></span>:<span className='pi pi-angle-down ml-1'></span>)
    ...
    <nav className='w-full bg-gray-800 h-20 px-4 fixed top-0 z-10'>
        <div className="flex justify-between items-center w-full h-full">
          ...
          <ul className="flex space-x-4 list-none">
            ...
            <li onClick={toggleWatchedMenu} className='relative cursor-pointer' ref={watchedMenuRef}>
              <a className='hover:text-gray-400'>Watched/Read</a>
              {watchedIcon}
            ...
            <li onClick={toggleRecomMenu} className='relative cursor-pointer' ref={recomMenuRef}>
              <a className='hover:text-gray-400' >Get Recommendation</a>
              {recomIcon}
